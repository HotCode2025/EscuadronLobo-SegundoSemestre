...
public class PrecargaDatos {
    ...
    private static void precargarUsuarios() {
        ...
        usuarios.add(new Cocinero("Natalia Cocinera", "33333333", "cocina1", "cocina123", "Sucursal Centro"));
        ...
        usuarios.add(new Cliente("Damian", "12345678", "damian123", "damian123", 3000, "987654321", "Calle 23"));
    }
    ...
    private static void precargarMenu() {
        menu.add(new Plato("Ensalada Cesar", "entrada", 120.0));
    ...
    pedidos.add(new Pedido(1, "mesa 2", "cliente1",
            new ArrayList<>(Arrays.asList(menu.get(0), menu.get(1))), "pendiente"));
    pedidos.add(new Pedido(2, "mesa 2", "cliente2",
            new ArrayList<>(Arrays.asList(menu.get(2), menu.get(3))), "en preparación"));
    pedidos.add(new Pedido(3, "mesa 1", "Rambo55",
            new ArrayList<>(Arrays.asList(menu.get(0), menu.get(3))), "listo"));
    }
