...
public class GestionPedidos {
    ...
    public static void registrarPago() {
        ...
        if (pedido == null) {
            System.out.println("❌ Pedido no encontrado o no está listo para cobrar.");
            return;
        }
    ...
    public static void emitirComprobante() {
        ...
        if (pedido == null) {
            System.out.println("❌ Pedido no encontrado o no está listo/cobrado.");
            return;
        }
    ...
    public static void marcarEnPreparacion() {
        ...
        if (!pedido.getEstado().equalsIgnoreCase("pendiente")) {
            System.out.println("⚠️ Solo se pueden marcar como 'en preparación' los pedidos pendientes.");
            return;
        }

        pedido.setEstado("en preparación");
        System.out.println("✅ Pedido " + pedido.getId() + " marcado como 'en preparación'.");
    }
    ...
    public static void marcarListo() {
        ...
        if (!pedido.getEstado().equalsIgnoreCase("en preparación")) {
            System.out.println("⚠️ Solo se pueden marcar como 'listo' los pedidos en preparación.");
            return;
        }
    ...
    public static void tomarPedido() {
        ...
        if (platos.isEmpty()) {
            System.out.println("❌ No se seleccionó ningún plato.");
            return;
        }
    ...
    public static void eliminarPlatosPedido(Pedido pedido) {
        ...
        if (platos.isEmpty()) {
            System.out.println("❌ No hay platos para eliminar.");
            return;
        }
    ...
    public static void mostrarDireccionesEntrega() {
        System.out.println("\n🗺️ LISTA DE DIRECCIONES DE ENTREGA\n");
        ...
        for (Pedido pedido : pendientes) {
            ...
            if (cliente != null) {
                ...
                System.out.println("⚠️ Cliente no encontrado para el pedido #" + pedido.getId());
            }
        }
    }
    ...
    public static void mostrarHistorialEntregas() {
        ...
        if (entregas.isEmpty()) {
            System.out.println("⚠️ No hay entregas registradas aún.");
            return;
        }
    ...
    public static void hacerPedido() {
        ...
        System.out.println("✅ Pedido registrado con éxito. ID del pedido: " + idNuevo);
    }
    ...
    public static void consultarEstadoPedido() {
        ...
        if (pedidosCliente.isEmpty()) {
            System.out.println("❌ No se encontraron pedidos para el usuario '" + usuario + "'.");
            return;
        }
    ...
    public static void repetirUltimoPedido(Cliente cliente) {
        ...
        System.out.println("✅ Pedido #" + nuevo.getId() + " repetido con éxito.");
    }
